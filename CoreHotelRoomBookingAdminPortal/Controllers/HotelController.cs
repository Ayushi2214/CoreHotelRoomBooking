...
namespace CoreHotelRoomBookingAdminPortal.Controllers
{
    public class HotelController : Controller
    {
        ...
        public IActionResult Create([Bind("HotelName, HotelDescription,HotelAddress,City,State,Country,HotelEmailId,HotelRating,HotelContactNumber,HotelDescription")] Hotel h1)
        {
